...
<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::open(array('url'=>'modelo','method'=>'POST','autocomplete'=>'off'))!!}
            {{Form::token()}}                        
			...
			<div class="form-group">
                ...
                <option value = "">-- Selecione um fabricante</option>
					@foreach ($fabricantes->all() as $fab)
						<option value = "{{ $fab->id }}">{{$fab->descricao}}</option>
					@endforeach
				</select>
			</div>
            ...
            <div class="form-group">
            	...
            	<input type="text" name="descricao" class="form-control" placeholder="Modelo do veículo...">
			</div>			
